...
(function dartProgram() {
  ...
  A = {JS_CONST: function JS_CONST() {
    ...
    runCancellable(operation, $T) {
      ...
      A.runZoned(new A.runCancellable_closure(t1, operation, $T), A.LinkedHashMap_LinkedHashMap$_literal([B.Symbol_hNH, token], t2, t2), type$.void);
      return t1.token;
    },
    checkIfCancelled() {
      var token = $.Zone__current.$index(0, B.Symbol_hNH);
    ...
    CompleteIdbRequest_complete(_this, $T) {
      var t1 = new A._Future($.Zone__current, $T._eval$1("_Future<0>")),
        ...
        t3 = type$.JSObject;
      A._EventStreamSubscription$0(_this, "success", t2._as(new A.CompleteIdbRequest_complete_closure(completer, _this, $T)), false, t3);
      A._EventStreamSubscription$0(_this, "error", t2._as(new A.CompleteIdbRequest_complete_closure0(completer, _this)), false, t3);
      A._EventStreamSubscription$0(_this, "blocked", t2._as(new A.CompleteIdbRequest_complete_closure1(completer, _this)), false, t3);
      return t1;
    },
    ...
    main() {
      ...
      A._EventStreamSubscription$(t1, "connect", type$.nullable_void_Function_Event._as(new A.main_closure(A.ServerImplementation$(new A.DatabaseConnection(new A.WebDatabase(new A._WebDelegate(new A._IndexedDbStorage("nfe", false), null, null, false), false, true, new A.Lock(), new A.Lock())), false, true))), false, type$.Event);
    },
  ...
  A.DriftCommunication_closure.prototype = {
    call$0() {
      var t1, t2, t3;
      for (t1 = this.$this, t2 = t1._pendingRequests, t3 = new A.LinkedHashMapValueIterator(t2, t2._modifications, t2._first, t2.$ti._eval$1("LinkedHashMapValueIterator<2>")); t3.moveNext$0();)
        t3.__js_helper$_current.completeWithError$1(B.C_ConnectionClosedException);
  ...
  A.DriftCommunication_setRequestHandler_closure.prototype = {
    ...
    $call$body$DriftCommunication_setRequestHandler_closure(request) {
      var $async$goto = 0,
        $async$completer = A._makeAsyncAwaitCompleter(type$.void),
        $async$returnValue, $async$handler = 2, $async$errorStack = [], $async$self = this, e, s, t1, t2, exception, response, $async$exception;
  ...
  A.DriftProtocol.prototype = {
    ...
    deserialize$1(message) {
      ...
      if (!type$.List_dynamic._is(message))
        throw A.wrapException(B.FormatException_NvI);
      ...
      throw A.wrapException(B.FormatException_IWx);
    },
    ...
    decodePayload$1(encoded) {
      ...
      switch (tag) {
        ...
        case 3:
          method = B.JSArray_methods.$index(B.List_s6K, readInt.call$1(1));
        ...
        case 5:
          return new A.RunNestedExecutorControl(B.JSArray_methods.$index(B.List_ttt, readInt.call$1(1)), readNullableInt.call$1(2));
        case 6:
          return new A.EnsureOpen(readInt.call$1(1), readNullableInt.call$1(2));
        case 13:
          t1.toString;
          return new A.ServerInfo(A.EnumByName_byName(B.List_rcv, A._asString(J.$index$asx(t1, 1)), type$.SqlDialect));
        case 7:
  ...
  A.ServerImplementation.prototype = {
    ...
    _spawnTransaction$2(comm, executor) {
      var $async$goto = 0,
        ...
        $async$returnValue, $async$self = this, transaction;
    ...
    _spawnExclusive$2(comm, executor) {
      var $async$goto = 0,
        $async$completer = A._makeAsyncAwaitCompleter(type$.int),
        $async$returnValue, $async$self = this, exclusive;
  ...
  A._ServerDbUser.prototype = {
    ...
    beforeOpen$body$_ServerDbUser(executor, details) {
      var $async$goto = 0,
        $async$completer = A._makeAsyncAwaitCompleter(type$.void),
        $async$handler = 1, $async$errorStack = [], $async$next = [], $async$self = this, t2, id0, t3, t1, id;
  ...
  A._StatementBasedTransactionExecutor.prototype = {
    ...
    rollback$0() {
      var $async$goto = 0,
        $async$completer = A._makeAsyncAwaitCompleter(type$.void),
        $async$returnValue, $async$handler = 2, $async$errorStack = [], $async$next = [], $async$self = this;
  ...
  A._StatementBasedTransactionExecutor_ensureOpen_closure.prototype = {
    call$0() {
      var $async$goto = 0,
        ...
        $async$handler = 1, $async$errorStack = [], $async$self = this, e, s, t1, exception, $async$exception;
      var $async$call$0 = A._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
        if ($async$errorCode === 1) {
          $async$errorStack.push($async$result);
          $async$goto = $async$handler;
  ...
  A.DelegatedDatabase_ensureOpen_closure.prototype = {
    call$0() {
      var $async$goto = 0,
        ...
        $async$returnValue, $async$handler = 2, $async$errorStack = [], $async$self = this, e, s, _0_0, t2, t3, exception, t1, $async$exception;
      var $async$call$0 = A._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
        if ($async$errorCode === 1) {
          $async$errorStack.push($async$result);
          $async$goto = $async$handler;
  ...
  A._WebDelegate.prototype = {
    ...
    runBatched$1(statements) {
      var t2, t3, t4, t5, t6, _i, application,
        t1 = A._setArrayType([], type$.JSArray_PreparedStatement);
      for (t2 = statements.statements, t3 = t2.$ti, t2 = new A.ListIterator(t2, t2.get$length(0), t3._eval$1("ListIterator<ListBase.E>")), t4 = type$.JSObject, t3 = t3._eval$1("ListBase.E"); t2.moveNext$0();) {
        t5 = t2.__internal$_current;
        if (t5 == null)
          t5 = t3._as(t5);
        t6 = this.___WebDelegate__db_A;
        t6 === $ && A.throwLateFieldNI("_db");
        t1.push(new A.PreparedStatement(t4._as(t6._obj.prepare(t5))));
      }
  ...
  (function installTearOffs() {
    ...
    _static(A, "async___rootHandleUncaughtError$closure", 5, null, ["call$5"], ["_rootHandleUncaughtError"], 59, 0);
    ...
    _static(A, "async___rootRunBinary$closure", 6, null, ["call$3$6"], ["_rootRunBinary"], 62, 0);
    ...
    _static(A, "async___rootErrorCallback$closure", 5, null, ["call$5"], ["_rootErrorCallback"], 66, 0);
    _static(A, "async___rootScheduleMicrotask$closure", 4, null, ["call$4"], ["_rootScheduleMicrotask"], 67, 0);
    _static(A, "async___rootCreateTimer$closure", 5, null, ["call$5"], ["_rootCreateTimer"], 68, 0);
    _static(A, "async___rootCreatePeriodicTimer$closure", 5, null, ["call$5"], ["_rootCreatePeriodicTimer"], 69, 0);
    _static(A, "async___rootPrint$closure", 4, null, ["call$4"], ["_rootPrint"], 70, 0);
    _static_1(A, "async___printToZone$closure", "_printToZone", 71);
    ...
    var _;
    _instance_1_i(_ = A._StreamController.prototype, "get$add", "add$1", 19);
    ...
    _instance(A.MessagePort.prototype, "get$postMessage", 1, 1, null, ["call$2", "call$1"], ["postMessage$2", "postMessage$1"], 30, 0, 0);
    _instance_1_u(A.DriftCommunication.prototype, "get$_handleMessage", "_handleMessage$1", 19);
    _instance_1_u(A.DriftProtocol.prototype, "get$_decodeDbValue", "_decodeDbValue$1", 13);
    ...
    _static_1(A, "sql_js_SqlJsModule_____tearOff$closure", "SqlJsModule_____tearOff", 74);
  ...
  (function inheritance() {
    ...
    _inheritMany(A.Closure2Args, [A.initHooks_closure0, A._awaitOnObject_closure0, A._wrapJsFunctionForAsync_closure, A._Future__chainForeignFuture_closure0, A._Future__propagateToListeners_handleWhenCompleteCallback_closure0, A._cancelAndErrorClosure_closure, A.HashMap_HashMap$from_closure, A.MapBase_mapToString_closure, A._BigIntImpl_hashCode_combine, A.Uri__parseIPv4Address_error, A.Uri_parseIPv6Address_error, A.Uri_parseIPv6Address_parseHex, A.MidiInputMap_keys_closure, A.MidiInputMap_values_closure, A.MidiOutputMap_keys_closure, A.MidiOutputMap_values_closure, A.RtcStatsReport_keys_closure, A.RtcStatsReport_values_closure, A.Storage_keys_closure, A.Storage_values_closure, A._StructuredClone_walk_closure, A._StructuredClone_walk_closure0, A._AcceptStructuredClone_walk_closure, A.AudioParamMap_keys_closure, A.AudioParamMap_values_closure, A.Frame_Frame$parseV8_closure_parseJsLocation]);
    ...
    _inheritMany(A.Stream, [A._StreamImpl, A._EventStream0, A._EventStream]);
    ...
    _inheritMany(A.EventTarget, [A.Node, A.FileWriter, A.MessagePort, A.WorkerGlobalScope, A.SourceBuffer, A._SourceBufferList_EventTarget_ListMixin, A.TextTrack, A.TextTrackCue, A._TextTrackList_EventTarget_ListMixin, A.VideoTrackList, A.AudioTrackList, A.BaseAudioContext]);
  ...
  var init = {
    ...
    mangledNames: {},
    types: ["~()", "bool(String)", "~(String,@)", "~(JSObject)", "Frame()", "Null()", "~(@)", "Future<~>()", "Frame(String)", "Null(@)", "~(Object,StackTrace)", "String(String)", "~(Event)", "Object?(Object?)", "~(~())", "String(int)", "Trace(String)", "Null(Object,StackTrace)", "bool()", "~(Object?)", "~(@,@)", "@()", "int(int,int)", "int(int)", "~(String,String)", "bool(~)", "Future<int>()", "Future<Null>()", "int(Frame)", "String(Frame)", "~(@[List<Object>?])", "~(Object?,Object?)", "Future<~>(Request)", "int?(int)", "Null(~)", "ResponsePayload?/(Request)", "~(int,@)", "Future<ResponsePayload?>()", "CancellationToken<@>?()", "Future<QueryResult>()", "Null(~())", "@(@,String)", "int()", "Future<bool>()", "Map<String,@>(List<Object?>)", "~(MessageEvent)", "Null(JSObject)", "~(String,int)", "~(String,int?)", "String(String?)", "List<Frame>(Trace)", "0^(0^,0^)<num>", "@(String)", "String(Trace)", "Null(bool)", "@(@)", "Frame(String,String)", "Trace()", "~(Object[StackTrace?])", "~(Zone?,ZoneDelegate?,Zone,Object,StackTrace)", "0^(Zone?,ZoneDelegate?,Zone,0^())<Object?>", "0^(Zone?,ZoneDelegate?,Zone,0^(1^),1^)<Object?,Object?>", "0^(Zone?,ZoneDelegate?,Zone,0^(1^,2^),1^,2^)<Object?,Object?,Object?>", "0^()(Zone,ZoneDelegate,Zone,0^())<Object?>", "0^(1^)(Zone,ZoneDelegate,Zone,0^(1^))<Object?,Object?>", "0^(1^,2^)(Zone,ZoneDelegate,Zone,0^(1^,2^))<Object?,Object?,Object?>", "AsyncError?(Zone,ZoneDelegate,Zone,Object,StackTrace?)", "~(Zone?,ZoneDelegate?,Zone,~())", "Timer(Zone,ZoneDelegate,Zone,Duration,~())", "Timer(Zone,ZoneDelegate,Zone,Duration,~(Timer))", "~(Zone,ZoneDelegate,Zone,String)", "~(String)", "Zone(Zone?,ZoneDelegate?,Zone,ZoneSpecification?,Map<Object?,Object?>?)", "Null(@,StackTrace)", "SqlJsModule(JSObject)", "Null(@,@)", "@(@,@)", "int(Trace)"],
...
;
    ...
    B.FormatException_IWx = new A.FormatException("Unknown tag", null, null);
    B.FormatException_NvI = new A.FormatException("Cannot read message", null, null);
    ...
    B.List_L4j = A._setArrayType(makeConstList([B.UpdateKind_0, B.UpdateKind_1, B.UpdateKind_2]), A.findType("JSArray<UpdateKind>"));
    ...
    B.List_rcv = A._setArrayType(makeConstList([B.SqlDialect_0_sqlite, B.SqlDialect_1_mysql, B.SqlDialect_2_postgres, B.SqlDialect_3_mariadb]), A.findType("JSArray<SqlDialect>"));
    ...
    B.List_s6K = A._setArrayType(makeConstList([B.StatementMethod_0, B.StatementMethod_1, B.StatementMethod_2, B.StatementMethod_3]), A.findType("JSArray<StatementMethod>"));
    ...
    B.List_ttt = A._setArrayType(makeConstList([B.NestedExecutorControl_0, B.NestedExecutorControl_1, B.NestedExecutorControl_2, B.NestedExecutorControl_3, B.NestedExecutorControl_4]), A.findType("JSArray<NestedExecutorControl>"));
    ...
    B.Symbol_hNH = new A.Symbol("drift.runtime.cancellation");
