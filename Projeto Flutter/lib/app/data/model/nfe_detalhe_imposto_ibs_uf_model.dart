...
class NfeDetalheImpostoIbsUfModel extends ModelBase {
  int? id;
  int? idNfeDetalhe;
  String? cst;
  ...
  NfeDetalheImpostoIbsUfModel.fromJson(Map<String, dynamic> jsonData) {
    id = jsonData['id'];
  ...
  static NfeDetalheImpostoIbsUfModel fromPlutoRow(PlutoRow row) {
    return NfeDetalheImpostoIbsUfModel(
  ...
  NfeDetalheImpostoIbsUfModel clone() {
    return NfeDetalheImpostoIbsUfModel(
      id: id,
