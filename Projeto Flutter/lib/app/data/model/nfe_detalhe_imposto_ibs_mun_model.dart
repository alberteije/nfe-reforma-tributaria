...
class NfeDetalheImpostoIbsMunModel extends ModelBase {
  int? id;
  int? idNfeDetalhe;
  String? cst;
  ...
  NfeDetalheImpostoIbsMunModel.fromJson(Map<String, dynamic> jsonData) {
    id = jsonData['id'];
  ...
  static NfeDetalheImpostoIbsMunModel fromPlutoRow(PlutoRow row) {
    return NfeDetalheImpostoIbsMunModel(
  ...
  NfeDetalheImpostoIbsMunModel clone() {
    return NfeDetalheImpostoIbsMunModel(
      id: id,
