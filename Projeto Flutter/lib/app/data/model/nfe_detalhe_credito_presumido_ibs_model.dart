...
class NfeDetalheCreditoPresumidoIbsModel extends ModelBase {
  int? id;
  int? idNfeDetalhe;
  ...
  NfeDetalheCreditoPresumidoIbsModel({
    this.id,
    this.idNfeDetalhe,
  ...
  NfeDetalheCreditoPresumidoIbsModel.fromJson(Map<String, dynamic> jsonData) {
    id = jsonData['id'];
    idNfeDetalhe = jsonData['idNfeDetalhe'];
    codigoClassificacao = NfeDetalheCreditoPresumidoIbsDomain.getCodigoClassificacao(jsonData['codigoClassificacao']);
  ...
  Map<String, dynamic> get toJson {
    ...
    jsonData['codigoClassificacao'] = NfeDetalheCreditoPresumidoIbsDomain.setCodigoClassificacao(codigoClassificacao);
  ...
  static NfeDetalheCreditoPresumidoIbsModel fromPlutoRow(PlutoRow row) {
    return NfeDetalheCreditoPresumidoIbsModel(
  ...
  NfeDetalheCreditoPresumidoIbsModel clone() {
    return NfeDetalheCreditoPresumidoIbsModel(
      id: id,
