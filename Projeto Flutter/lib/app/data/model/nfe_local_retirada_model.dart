...
class NfeLocalRetiradaModel extends ModelBase {
  int? id;
  int? idNfeCabecalho;
  String? cnpj;
  String? cpf;
  ...
  static NfeLocalRetiradaModel fromPlutoRow(PlutoRow row) {
    return NfeLocalRetiradaModel(
      ...
      nomeExpedidor: row.cells['nomeExpedidor']?.value,
  ...
  PlutoRow toPlutoRow() {
    return PlutoRow(
      cells: {
        ...
        'nomeExpedidor': PlutoCell(value: nomeExpedidor ?? ''),
