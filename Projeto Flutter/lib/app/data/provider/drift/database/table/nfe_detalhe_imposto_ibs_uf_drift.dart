...
@DataClassName("NfeDetalheImpostoIbsUf")
class NfeDetalheImpostoIbsUfs extends Table {
	@override
	String get tableName => 'nfe_detalhe_imposto_ibs_uf';
...
class NfeDetalheImpostoIbsUfGrouped {
	NfeDetalheImpostoIbsUf? nfeDetalheImpostoIbsUf; 

  NfeDetalheImpostoIbsUfGrouped({
