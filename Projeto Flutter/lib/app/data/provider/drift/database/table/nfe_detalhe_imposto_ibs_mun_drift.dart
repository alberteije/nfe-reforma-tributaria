...
@DataClassName("NfeDetalheImpostoIbsMun")
class NfeDetalheImpostoIbsMuns extends Table {
	@override
	String get tableName => 'nfe_detalhe_imposto_ibs_mun';
...
class NfeDetalheImpostoIbsMunGrouped {
	NfeDetalheImpostoIbsMun? nfeDetalheImpostoIbsMun; 

  NfeDetalheImpostoIbsMunGrouped({
