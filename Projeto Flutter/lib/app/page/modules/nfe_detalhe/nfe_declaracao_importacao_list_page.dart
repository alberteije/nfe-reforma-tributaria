...
class NfeDeclaracaoImportacaoListPage extends ListPageBase<NfeDeclaracaoImportacaoController> {
  const NfeDeclaracaoImportacaoListPage({Key? key}) : super(key: key);
