...
class NfeTransporteVolumeLacreListPage extends ListPageBase<NfeTransporteVolumeLacreController> {
  const NfeTransporteVolumeLacreListPage({Key? key}) : super(key: key);
