...
class NfeProcessoReferenciadoListPage extends ListPageBase<NfeProcessoReferenciadoController> {
  const NfeProcessoReferenciadoListPage({Key? key}) : super(key: key);
