...
class NfeInformacaoAgropecuarioListPage extends ListPageBase<NfeInformacaoAgropecuarioController> {
  const NfeInformacaoAgropecuarioListPage({Key? key}) : super(key: key);
