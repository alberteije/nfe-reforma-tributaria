...
class NfeCupomFiscalReferenciadoListPage extends ListPageBase<NfeCupomFiscalReferenciadoController> {
  const NfeCupomFiscalReferenciadoListPage({Key? key}) : super(key: key);
