...
class NfeProdRuralReferenciadaListPage extends ListPageBase<NfeProdRuralReferenciadaController> {
  const NfeProdRuralReferenciadaListPage({Key? key}) : super(key: key);
