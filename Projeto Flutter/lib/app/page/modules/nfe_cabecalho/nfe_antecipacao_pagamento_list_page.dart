...
class NfeAntecipacaoPagamentoListPage extends ListPageBase<NfeAntecipacaoPagamentoController> {
  const NfeAntecipacaoPagamentoListPage({Key? key}) : super(key: key);
