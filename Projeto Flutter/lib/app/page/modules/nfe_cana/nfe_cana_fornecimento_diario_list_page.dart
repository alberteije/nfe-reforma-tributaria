...
class NfeCanaFornecimentoDiarioListPage extends ListPageBase<NfeCanaFornecimentoDiarioController> {
  const NfeCanaFornecimentoDiarioListPage({Key? key}) : super(key: key);
