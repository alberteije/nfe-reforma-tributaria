...
import 'package:nfe/app/data/provider/drift/platform/platform.dart';
import 'package:nfe/app/page/shared_page/splash_screen_page.dart';
import 'package:nfe/app/routes/app_pages.dart';
import 'package:nfe/app/translations/app_translation.dart';
import 'app/data/provider/drift/database/database.dart';

void main() async {
	WidgetsFlutterBinding.ensureInitialized();

  Get.lazyPut(() => AppDatabase(Platform.createDatabaseConnection('nfe')));
